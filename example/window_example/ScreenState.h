...
struct ScreenState {
  ...
  bool Has(MouseButtonFlags flag) const { return (MouseFlag & flag) != 0; }
  ...
  void Clear() {
    Unset((MouseButtonFlags)(MouseButtonFlags::WheelMinus |
                             MouseButtonFlags::WheelPlus |
                             MouseButtonFlags::CursorUpdate));
  }
  ...
  bool HasCapture() const {
    return Has(MouseButtonFlags::LeftDown) ||
           Has(MouseButtonFlags::RightDown) ||
           Has(MouseButtonFlags::MiddleDown);
  }
