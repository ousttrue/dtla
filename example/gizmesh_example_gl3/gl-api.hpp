...
public:
    ...
    void uniform(const std::string &name, const std::array<float, 2> &vec) const { glProgramUniform2fv(program, get_uniform_location(name), 1, &vec[0]); }
    void uniform(const std::string &name, const std::array<float, 3> &vec) const { glProgramUniform3fv(program, get_uniform_location(name), 1, &vec[0]); }
    ...
    void uniform(const std::string &name, const std::array<float, 16> &vec) const { glProgramUniform4fv(program, get_uniform_location(name), 1, &vec[0]); }
    void uniform(const std::string &name, const std::array<float, 9> &mat) const { glProgramUniformMatrix3fv(program, get_uniform_location(name), 1, GL_FALSE, &mat[0]); }
    // void uniform(const std::string &name, const std::array<float, 16> &mat) const { glProgramUniformMatrix4fv(program, get_uniform_location(name), 1, GL_FALSE, &mat[0]); }
    ...
    void uniform(const std::string &name, const int elements, const std::vector<std::array<float, 2>> &vec) const { glProgramUniform2fv(program, get_uniform_location(name), elements, &vec[0][0]); }
    void uniform(const std::string &name, const int elements, const std::vector<std::array<float, 3>> &vec) const { glProgramUniform3fv(program, get_uniform_location(name), elements, &vec[0][0]); }
    // void uniform(const std::string &name, const int elements, const std::vector<std::array<float, 9>> &mat) const { glProgramUniformMatrix3fv(program, get_uniform_location(name), elements, GL_FALSE, &mat[0]); }
    // void uniform(const std::string &name, const int elements, const std::vector<std::array<float, 16>> &mat) const { glProgramUniformMatrix4fv(program, get_uniform_location(name), elements, GL_FALSE, &mat[0]); }
