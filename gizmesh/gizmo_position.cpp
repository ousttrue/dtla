...
static bool axisDragger(const GizmoComponent &component, const fpalg::Ray &worldRay, const GizmoState &state,
...
namespace handle
{
bool translation(const GizmoSystem &ctx, uint32_t id, fpalg::TRS &trs, bool is_local)
{
